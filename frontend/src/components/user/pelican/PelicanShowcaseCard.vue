  ...
  >
    ...
    <div class="flex items-start justify-between gap-3 px-4 py-3">
      ...
      <div class="flex shrink-0 flex-col items-end gap-1 text-xs">
        <span class="rounded-md bg-primary-50 px-1.5 py-0.5 font-medium text-primary-700 dark:bg-primary-900/20 dark:text-primary-300" data-testid="showcase-source">{{ t(item.source_scope === 'group' ? 'pelicanShowcase.sourceGroup' : 'pelicanShowcase.sourceAccount') }}</span>
        <span
          v-if="effortLabel"
