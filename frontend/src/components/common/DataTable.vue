    ...
    <template v-else>
      ...
      >
        <div class="space-y-3">
          ...
          >
            <span class="max-w-[42%] shrink-0 text-xs font-medium uppercase tracking-wider text-gray-500 dark:text-dark-400">
              {{ column.label }}
            </span>
            <div class="min-w-0 max-w-full break-words text-right text-sm text-gray-900 dark:text-gray-100">
