<template>
  <div class="flex flex-col gap-0.5">
    <!-- 并发槽位 -->
    <AccountIPChannelsCell v-if="account.ip_channels?.length" :channels="account.ip_channels" @manage="emit('manage')" />
...
import AccountIPChannelsCell from '@/components/account/AccountIPChannelsCell.vue'
