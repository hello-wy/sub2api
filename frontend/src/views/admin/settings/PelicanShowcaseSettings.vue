  ...
  <div class="card" data-testid="pelican-showcase-settings">
    ...
    <div class="card-body space-y-5">
      <div class="flex items-center justify-between gap-4">
        <div>
          <label for="pelican-showcase-enabled" class="text-sm font-medium text-gray-700 dark:text-gray-300">
        ...
        <Toggle id="pelican-showcase-enabled" v-model="enabledModel" data-testid="pelican-showcase-enabled" />
      </div>
