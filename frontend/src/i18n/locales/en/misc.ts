export default {
  ...
  payment: {
    ...
    rechargeRatePreview: 'Current rate: 1 {currency} = ${usd}',
    ...
    errors: {
      ...
      PLAN_PURCHASE_COOLDOWN: 'This plan is still in its repurchase cooldown. You can buy it again after {available_at}.',
    ...
    admin: {
      ...
      subscriptionPlanDistribution: 'Subscription Purchase Distribution',
      purchaseCount: 'Purchases',
      unknownSubscriptionPlan: 'Unknown Plan',
      ...
      repurchaseCooldown: 'Repurchase Cooldown (Hours)',
      repurchaseCooldownHint: 'After a successful purchase, the user must wait this many hours before buying the same plan again. Set to 0 for no limit.',
      repurchaseCooldownInvalid: 'Repurchase cooldown must be an integer greater than or equal to 0.',
	  ...
	  totalLimit: 'Subscription Total Limit',
      unlimited: 'Unlimited',
