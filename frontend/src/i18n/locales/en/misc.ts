export default {
  ...
  payment: {
    ...
    admin: {
      ...
      groupRevenueEfficiency: 'Group Revenue Efficiency',
      groupRevenueEfficiencyDescription: 'Paid amount and subscription quota usage',
      groupName: 'Group',
      groupMultiplier: 'Group multiplier',
      groupRevenue: 'Paid amount',
      expectedQuota: 'Expected quota',
      userDeductedQuota: 'User deducted quota',
      groupBaseUsage: 'Base usage',
      unitRevenue: 'Revenue per base unit',
      noUsage: 'No usage',
