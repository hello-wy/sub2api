export default {
  ...
  usage: {
    ...
    tabs: { usage: 'Usage', business: 'Business Analysis', errors: 'Error Requests', ranking: 'User Ranking' },
    errors: {
  ...
  pelicanShowcase: {
    sourceGroup: 'Group test',
    sourceAccount: 'Account sample',
    title: 'Pelican Showcase',
    description: 'Browse scheduled Pelican drawings. Group tests use the actual group route; account samples come from individual account tests.',
    allGroups: 'All groups',
  ...
  wallet: {
    ...
    customCreditPlaceholder: 'Enter the $ balance to receive',
    estimatedPayment: 'Estimated payment',
    activeSubscriptions: 'Active subscriptions',
    subscriptionGroupNotice: 'Subscriptions in different groups can remain active together. Repurchasing the same group starts a new term immediately and unused benefits will not carry over.',
    subscriptionOverrideTitle: 'Renew this subscription group?',
    subscriptionOverrideMessage: 'Your current subscription in “{name}” has {days} days remaining. Repurchasing this group starts a new term immediately and unused benefits will not carry over.',
    subscriptionOverrideNoExpiryMessage: 'Your current subscription in “{name}” is still active. Repurchasing this group starts a new term immediately and unused benefits will not carry over.',
  ...
  loyalty: {
    ...
    weeklyPointsHint: 'Valid for the current week',
    permanentPointsHint: 'Cumulative long-term points',
    pointsUnit: 'points',
    exchangeRule: '1 CNY = 1 point',
    bestDiscount: 'Best unlocked discount: {discount}%',
    highestDiscount: 'Best Discount',
    bestDiscountHint: 'Highest recharge discount currently unlocked',
    recharge: 'Recharge',
    rechargeNow: 'Recharge Now',
    rechargeHint: 'More recharge points unlock better tiers and discounts',
    attributeMissingTitle: 'Membership points field is not configured',
    attributeMissingDesc: 'Add number attributes with keys loyalty_weekly_points and loyalty_permanent_points in user attribute settings.',
    weeklyPlan: 'Weekly Benefits',
    weeklyPlanShort: 'Weekly Plan',
    weeklyHint: 'Current-week points unlock the matching discount.',
    weeklyBadge: 'Weekly settlement',
    permanentPlan: 'Lifetime Benefits',
    permanentPlanShort: 'Lifetime Plan',
    permanentHint: 'Cumulative points unlock retained discounts.',
    permanentBadge: 'Always active',
    currentLevel: 'Current Level',
    unlockedDiscount: '{discount}% recharge discount unlocked',
    noTierHint: 'Reach a threshold to unlock a discount',
    weeklyProgress: 'Weekly Progress',
    weeklyDiscount: 'Weekly Discount',
    permanentDiscount: 'Lifetime Discount',
    nextGoal: 'Next Goal',
    nextGoalText: '{points} points to unlock {level} with a {discount}% recharge discount.',
    remainingPoints: '{points} points remaining',
    allUnlocked: 'All tiers unlocked',
    maxLevel: 'Max Level',
    noTier: 'Locked',
    tierLabel: '{level} · {discount}% off',
    unlockAt: 'Unlock at {points} points',
    unlockAtCurrency: 'Unlock at CNY {amount}',
    ruleDiscount: '{discount}% recharge discount',
    progressToNext: 'Progress to next tier',
    rulesTitle: 'Rules',
    ruleHigherTitle: 'Tier benefit display',
    ruleHigherDesc: 'Reached thresholds show the matching tier.',
    weeklyResetTitle: 'Weekly plan window',
    weeklyResetDesc: 'Calculated from current-week points and reset each cycle.',
    permanentStableTitle: 'Long-term tier accrual',
    permanentStableDesc: 'Cumulative thresholds keep the long-term discount.',
    earnTitle: 'Point source',
    earnRechargeDesc: 'After balance recharge succeeds, weekly and lifetime points are both accumulated from the recharge amount.',
    attributeSourceTitle: 'Attribute source',
    attributeSourceDesc: 'Admins can add and maintain number attributes named loyalty_weekly_points and loyalty_permanent_points in user attribute settings.',
    bonusTitle: 'Community binding reward',
    bonusDesc: 'Recharge friends who join the group and bind QQ can receive +2 points.',
    detailsTitle: 'Benefit Details',
    detailsHint: 'Review thresholds, discounts, and current status for weekly and lifetime plans.',
    viewRules: 'View Notes',
    tablePlan: 'Plan',
    tableLevel: 'Level',
    tableCondition: 'Unlock Condition',
    tableDiscount: 'Discount',
    tableStatus: 'Status',
    weeklyRuleDescription: 'Weekly recharge discounts are shown after cycle points reach the threshold.',
    permanentRuleDescription: 'Lifetime recharge discounts are shown after total recharge reaches the threshold.',
