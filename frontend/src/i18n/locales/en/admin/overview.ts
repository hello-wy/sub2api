export default {
    ...
    users: {
      ...
      adjustLotteryTickets: 'Adjust Lottery Tickets',
      currentLotteryTickets: 'Current Available Tickets',
      lotteryTicketOperation: 'Adjustment Type',
      addLotteryTickets: 'Add Tickets',
      ...
      insufficientLotteryTickets: 'Insufficient lottery tickets',
      // Balance History
    ...
    groups: {
      ...
      modelsList: {
        title: 'Models List ({endpoint})',
        hint: 'Candidate models are loaded from {endpoint}.',
        loading: 'Loading candidate models...',
        empty: 'No candidate models available',
