export default {
    settings: {
      ...
      operations: {
        ...
        description: 'Configure the number of leaderboard positions and the reward ratio for each position.',
        rankLimit: 'Leaderboard positions',
        rankLimitHint: 'Set the number of displayed positions between 1 and 100.',
        rewardRatios: 'Position reward ratios',
        rewardRatiosHint: 'Set a reward ratio for each position: 1 means 100% and 0.5 means 50%.',
        ratioItem: 'Rank {rank}',
        ratioPlaceholder: 'For example: 1',
        membership: {
          title: 'Membership Plan Settings',
          description: 'Configure membership rebate rules for periodic and cumulative recharges.',
          weeklyPlan: 'Periodic Recharge Plan',
          weeklyPlanHint: 'Match rebate tiers by the accumulated recharge amount in each period.',
          permanentPlan: 'Cumulative Recharge Plan',
          permanentPlanHint: 'Match rebate tiers by the total historical recharge amount.',
          addRule: 'Add Rule',
          removeRule: 'Remove Rule',
          rechargeAmount: 'Recharge Amount',
          rebateRate: 'Rebate Rate',
          saveHint: 'New membership rules take effect immediately after saving.',
        },
      },
      features: {
        excelBpsImages: {
        ...
        pelicanShowcase: {
          ...
          description: 'Show scheduled group test output and account samples with their source identified. Disabled by default.',
          configureLink: 'Go to Group Management and use “Pelican test” in the group actions to add a schedule',
          ...
          groupsHint: 'Show these groups’ scheduled output and their account samples. Only successful HTML is included; account names stay private. Removing a group clears its snapshots within one minute.',
