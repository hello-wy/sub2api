...
accountHealth: {
      ...
      reasonManual: 'Manually isolated',
      reasonErrorRate: 'Automatically isolated: error rate {rate}',
      title: 'Account Health',
      description: 'Error-rate scores across all accounts. Unhealthy accounts are isolated automatically and recover on their own.',
      settings: 'Thresholds',
      enableAuto: 'Auto isolate unhealthy accounts',
      windowMinutes: 'Window (minutes)',
      minSamples: 'Min samples',
      isolateErrRate: 'Isolate above error rate (0-1)',
      recoverErrRate: 'Recover below error rate (0-1)',
      cooldownMinutes: 'Isolation cooldown (minutes)',
      intervalSeconds: 'Check interval (seconds)',
      settingsHint: 'Accounts with too few samples are never isolated. Isolation uses temporary unscheduling and expires automatically.',
      account: 'Account',
      platform: 'Platform',
      score: 'Score',
      errRate: 'Error rate',
      ...
      isolate: 'Isolate',
      resume: 'Resume',
      noData: 'No account activity in the window yet.',
      loadFailed: 'Failed to load account health',
      saveFailed: 'Failed to save',
      saveSuccess: 'Saved successfully',
      isolateSuccess: 'Account isolated for 24 hours',
      resumeSuccess: 'Account resumed',
      isolateFailed: 'Failed to isolate account',
      resumeFailed: 'Failed to resume account',
    },
    scheduledTests: {
