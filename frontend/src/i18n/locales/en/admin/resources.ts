export default {
    scheduledTests: {
      ...
      cancelGroup: 'Interrupt',
      cancelGroupHint: 'Stop this run and its retries; keep future scheduled runs',
      groupStatusCancelling: 'Interrupting',
      groupCancelRequested: 'Interrupt requested; stopping the current run',
      groupCancelError: 'Failed to interrupt the test',
      triggerGroup: 'Run now',
      groupStarted: 'Test started; status updates automatically',
      groupRetryHint: 'Failed outputs retry after 5 and 15 seconds, up to 2 retries. Normal billing applies to each request. Pausing or editing stops further retries.',
      groupPhaseWaiting: 'Waiting for model response',
      groupPhaseReceiving: 'Receiving stream',
      groupPhaseThinking: 'Model is thinking',
      groupPhaseGenerating: 'Generating artwork',
      groupPhaseSaving: 'Saving results',
      groupStatusStarting: 'Starting',
      groupStatusRunning: 'Testing',
      groupStatusRetrying: 'Waiting to retry',
      groupStatusSuccess: 'Test succeeded',
      groupStatusFailed: 'Test failed',
      groupStatusInterrupted: 'Run interrupted',
      groupStatusReady: 'Waiting for schedule',
      groupStatusPaused: 'Paused',
      groupProgress: 'Attempt {attempt}/{max} · Completed {completed}/{total} · Succeeded {succeeded} · Failed {failed}',
      groupElapsed: 'Elapsed {seconds}s',
      groupRetryCountdown: 'Retrying failed outputs in {seconds}s',
      groupLastError: 'Last error: {message}',
      groupStatusReconnect: 'Status update failed temporarily. Reconnecting…',
