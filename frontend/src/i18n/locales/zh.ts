export default {
  ...
  admin: {
    ...
    settings: {
      ...
      operations: {
        ...
        membership: {
          title: '会员计划参数',
          description: '配置周计划和永久计划的充值金额门槛与返利比例，结算页会按用户当前最高档位应用优惠。',
          weeklyPlan: '周计划',
          weeklyPlanHint: '按服务端自然周统计，周一重置。',
          permanentPlan: '永久计划',
          permanentPlanHint: '永久累计充值积分，长期保留已解锁档位。',
          rechargeAmount: '充值金额',
          rebateRate: '返利比例',
          addRule: '添加档位',
          removeRule: '删除档位',
          saveHint: '保存后新创建的充值订单会使用最新会员规则；已创建订单不受影响。',
        },
      },
  ...
  payment: {
    ...
    discountedPaymentAmount: '折后支付金额',
    actualPay: '实付金额',
    createOrder: '确认支付',
    methods: {
      easypay: '易支付',
