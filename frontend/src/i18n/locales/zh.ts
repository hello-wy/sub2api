export default {
  ...
  loyalty: {
    ...
    ruleHigherDesc: '累计积分获取限时或永久折扣。',
    weeklyResetTitle: '周计划机制',
    weeklyResetDesc: '每周根据上周累充计算等级。',
    permanentStableTitle: '永久折扣',
    permanentStableDesc: '累充到达一定程度获得永久折扣。',
    earnTitle: '积分来源',
