export default {
  ...
  admin: {
    ...
    settings: {
      ...
      operations: {
        subtabsLabel: 'Operations settings sections',
        subtabs: {
          welfare: 'Welfare Config',
        ...
        membership: {
          title: 'Membership Plan Parameters',
          description: 'Configure recharge thresholds and rebate rates for weekly and lifetime plans. Checkout uses the user’s best unlocked tier.',
          weeklyPlan: 'Weekly Plan',
          weeklyPlanHint: 'Calculated by server calendar week and reset every Monday.',
          permanentPlan: 'Lifetime Plan',
          permanentPlanHint: 'Cumulative recharge points that keep unlocked long-term tiers.',
          rechargeAmount: 'Recharge Amount',
          rebateRate: 'Rebate Rate',
          addRule: 'Add Tier',
          removeRule: 'Remove Tier',
          saveHint: 'New recharge orders use the latest membership rules after saving; existing orders are not changed.',
        },
      },
  ...
  payment: {
    ...
    fee: 'Fee',
    loyaltyDiscount: 'Membership Discount ({discount}%)',
    discountedPaymentAmount: 'Discounted Payment Amount',
