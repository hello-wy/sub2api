export default {
  ...
  loyalty: {
    ...
    description: 'Accumulate recharge points, level up weekly benefits dynamically, and unlock lifetime discounts from total recharge.',
    ...
    attributeMissingTitle: 'Loyalty points field is not configured',
    ...
    weeklyHint: 'Recharge discounts unlocked by this week\'s accumulated points.',
    weeklyBadge: 'Weekly settlement',
    permanentPlan: 'Lifetime Benefits',
    permanentPlanShort: 'Lifetime Plan',
    permanentHint: 'Unlock long-term tiers from cumulative recharge and keep the matched tier.',
    ...
    ruleHigherDesc: 'When points reach a threshold, this page shows the matching recharge tier; final billing follows order rules.',
    weeklyResetTitle: 'Weekly plan window',
    weeklyResetDesc: 'Weekly benefits show the tier for the current cycle, and point changes are reflected in progress.',
    permanentStableTitle: 'Long-term tier accrual',
    permanentStableDesc: 'Lifetime benefits are evaluated from cumulative recharge points and retained after thresholds are met.',
