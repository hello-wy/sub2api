export default {
  ...
  payment: {
    ...
    rechargeRatePreview: '当前倍率：1 {currency} = ${usd}',
    refundReason: '退款原因',
    ...
    errors: {
      ...
      PLAN_PURCHASE_COOLDOWN: '该套餐仍在重复购买冷却期，可于 {available_at} 后再次购买',
    ...
    admin: {
      ...
      totalRevenue: '总收入',
      todayOrders: '今日订单',
      subscriptionPlanDistribution: '订阅购买分布',
      purchaseCount: '购买次数',
      unknownSubscriptionPlan: '未知套餐',
      orderCount: '订单数',
      avgAmount: '平均金额',
      revenue: '收入',
      dailyRevenue: '每日收入',
      ...
      validity: '有效期',
      validityUnit: '有效期单位',
      repurchaseCooldown: '重复购买冷却（小时）',
      repurchaseCooldownHint: '用户成功购买后，需等待指定小时才能再次购买同一套餐；填写 0 表示不限制',
      repurchaseCooldownInvalid: '重复购买冷却必须是大于或等于 0 的整数',
      sortOrder: '排序',
      forSale: '上架状态',
      onSale: '上架',
      offSale: '下架',
