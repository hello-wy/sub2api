export default {
    settings: {
      ...
      operations: {
        ...
        title: '福利排行榜设置',
        description: '配置福利排行榜的展示名次和各名次奖励比例。',
        rankLimit: '排行榜展示名次',
        rankLimitHint: '设置 1 到 100 之间的展示名次数量。',
        rewardRatios: '名次奖励比例',
        rewardRatiosHint: '按名次设置奖励比例；1 表示 100%，0.5 表示 50%。',
        ratioItem: '第 {rank} 名',
        ratioPlaceholder: '例如：1',
        membership: {
          title: '会员计划设置',
          description: '配置周期充值和累计充值对应的会员返利规则。',
          weeklyPlan: '周期充值计划',
          weeklyPlanHint: '按每个统计周期内的累计充值金额匹配返利等级。',
          permanentPlan: '累计充值计划',
          permanentPlanHint: '按历史累计充值金额匹配返利等级。',
          addRule: '添加规则',
          removeRule: '删除规则',
          rechargeAmount: '充值金额',
          rebateRate: '返利比例',
          saveHint: '保存后，新的会员规则将立即生效。',
        },
      },
      features: {
        excelBpsImages: {
        ...
        pelicanShowcase: {
          title: '鹈鹕测智展示',
          description: '展示分组定时测试作品及组内账号测试样本，并标明来源。默认关闭。',
          configureLink: '前往 分组管理，在分组操作栏的「鹈鹕测试」里添加定时计划',
          enabled: '启用鹈鹕测智展示',
          enabledHint: '开启后用户侧边栏出现「鹈鹕测智」页面；关闭后页面隐藏、不再收录新作品，已保留的作品仍按下方规则清理。',
          groups: '展示分组',
          groupsHint: '展示这些分组的定时鹈鹕测试作品，以及组内账号的测试样本。只收录成功生成的 HTML，不显示账号名称。移出的分组，其作品会在一分钟内清理。',
      ...
      payment: {
        ...
        balanceRechargeMultiplierHint: '用户每支付 1 CNY 可获得多少 $',
        balanceRechargePreview: '预览：1 CNY = ${usd}',
