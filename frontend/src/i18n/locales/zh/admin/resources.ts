...
accountHealth: {
      ...
      reasonManual: '手动隔离',
      reasonErrorRate: '错误率为 {rate}，已自动隔离',
      title: '账号健康',
      description: '全站账号错误率评分，不健康的账号会被自动隔离，到期或恢复后自动解除。',
      settings: '阈值设置',
      enableAuto: '自动隔离不健康账号',
      windowMinutes: '统计窗口（分钟）',
      minSamples: '最少样本数',
      isolateErrRate: '隔离错误率（0-1）',
      recoverErrRate: '恢复错误率（0-1）',
      cooldownMinutes: '隔离时长（分钟）',
      intervalSeconds: '检查间隔（秒）',
      settingsHint: '样本不足的账号永不隔离。隔离使用临时摘除机制，到期自动恢复。',
      account: '账号',
      platform: '平台',
      score: '评分',
      errRate: '错误率',
      ...
      saveFailed: '保存失败',
      saveSuccess: '保存成功',
      isolateSuccess: '账号已隔离 24 小时',
      resumeSuccess: '账号已恢复',
      isolateFailed: '隔离账号失败',
      resumeFailed: '恢复账号失败',
    },
    scheduledTests: {
      title: '定时测试',
