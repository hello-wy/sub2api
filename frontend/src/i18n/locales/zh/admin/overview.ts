export default {
    ...
    users: {
      ...
      adjustLotteryTickets: '调整抽奖次数',
      currentLotteryTickets: '当前可用抽奖次数',
      lotteryTicketOperation: '调整类型',
      addLotteryTickets: '增加次数',
      ...
      insufficientLotteryTickets: '可用抽奖次数不足',
      // 余额变动记录
      balanceHistory: '充值记录',
    ...
    groups: {
      ...
      form: {
        name: '名称',
        tag: '标签',
        tagPlaceholder: '例如：生产、备用、欧洲节点',
        tagHint: '相同标签的分组可在账号设置中一键批量选择',
        description: '描述',
        platform: '平台',
        rateMultiplier: '费率倍数',
        status: '状态',
