export default {
  ...
  keys: {
    ...
    quotaLimit: '额度限制',
    quotaAmount: '额度金额 ($)',
    quotaAmountPlaceholder: '输入 $ 额度限制',
  ...
  usage: {
    ...
    tabs: { usage: '用量明细', business: '经营分析', errors: '错误请求', ranking: '用户排行' },
    errors: {
  ...
  pelicanShowcase: {
    ...
    sourceAccount: '账号样本',
    title: '鹈鹕测智',
    description: '查看定时鹈鹕绘图作品；分组测试经过实际分组路由，账号样本来自单个账号测试。',
    allGroups: '全部分组',
  ...
  wallet: {
    ...
    customCreditPlaceholder: '输入希望到账的 $ 余额',
    estimatedPayment: '预计支付',
    activeSubscriptions: '当前有效订阅',
    subscriptionGroupNotice: '不同订阅分组可同时生效；再次订阅同一分组会立即开启新周期，未使用的权益不会保留。',
    subscriptionOverrideTitle: '确认续订当前分组',
    subscriptionOverrideMessage: '当前分组“{name}”仍剩余 {days} 天。再次订阅该分组会立即开启新周期，未使用的权益不会保留。',
    subscriptionOverrideNoExpiryMessage: '当前分组“{name}”仍在生效。再次订阅该分组会立即开启新周期，未使用的权益不会保留。',
