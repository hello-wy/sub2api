...
export interface ApiKey {
  ...
  quota: number // Quota limit in $ credits (0 = unlimited)
  quota_used: number // Used quota amount in $ credits
...
export interface UpdateApiKeyRequest {
  ...
  ip_whitelist?: string[]
  ip_blacklist?: string[]
  quota?: number // Quota limit in $ credits (null = no change, 0 = unlimited)
