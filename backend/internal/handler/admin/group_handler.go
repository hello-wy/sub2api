...
func (h *GroupHandler) Update(c *gin.Context) {
	...
	group, err := h.adminService.UpdateGroup(c.Request.Context(), groupID, &service.UpdateGroupInput{
		...
		SubscriptionQuotaResetMode:      req.SubscriptionQuotaResetMode,
		SubscriptionTotalLimitUSD:       req.SubscriptionTotalLimitUSD.ToServiceInput(),
		SubscriptionTotalLimitUSDSet:    req.SubscriptionTotalLimitUSD.set,
		DailyLimitUSD:                   req.DailyLimitUSD.ToServiceInput(),
		DailyLimitUSDSet:                req.DailyLimitUSD.set,
		WeeklyLimitUSD:                  req.WeeklyLimitUSD.ToServiceInput(),
		WeeklyLimitUSDSet:               req.WeeklyLimitUSD.set,
		MonthlyLimitUSD:                 req.MonthlyLimitUSD.ToServiceInput(),
		MonthlyLimitUSDSet:              req.MonthlyLimitUSD.set,
		LongContextPricingEnabled:       req.LongContextPricingEnabled,
		ModelPricing:                    req.ModelPricing,
		AllowImageGeneration:            req.AllowImageGeneration,
		AllowBatchImageGeneration:       req.AllowBatchImageGeneration,
