...
type showcaseGroupReader struct {
	groups map[int64]*service.Group
}

func (r *showcaseGroupReader) GetByID(_ context.Context, id int64) (*service.Group, error) {
...
func TestSettingsPelicanShowcaseValidatesOnlyNewlyAddedGroups(t *testing.T) {
	h, repo := newStepUpSwitchTestHandler(t, map[string]string{})
	reader := &showcaseGroupReader{groups: map[int64]*service.Group{
