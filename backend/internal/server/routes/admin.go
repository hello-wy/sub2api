...
func registerUserManagementRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	users := admin.Group("/users")
	{
		...
		users.POST("/:id/lottery-tickets", h.Admin.User.AdjustLotteryTickets)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/codex-gateways", h.Admin.Account.ListCodexGateways)
...
func registerScheduledTestRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	...
	admin.GET("/groups/:id/scheduled-test-keys", h.Admin.ScheduledTest.ListGroupTestKeys)
}
