		...
		},
		{
			...
			wantJSON: `{
				...
				"data": {
					...
					"daily_checkin_reward_ranges": "[{\"min\":0.01,\"max\":1,\"probability\":0.5},{\"min\":1,\"max\":2,\"probability\":0.4},{\"min\":2,\"max\":2.5,\"probability\":0.0999},{\"min\":2.5,\"max\":3,\"probability\":0.0001}]",
					"daily_checkin_streak_rules": "[{\"threshold\":3,\"bonus\":3},{\"threshold\":7,\"bonus\":6},{\"threshold\":14,\"bonus\":12},{\"threshold\":30,\"bonus\":24}]",
