...
type AdminService interface {
	...
	// Account management
	ListCodexGateways(ctx context.Context) ([]string, error)
...
type UpdateGroupInput struct {
	...
	SubscriptionTotalLimitUSD    *float64 // 套餐总额度 (USD)
	SubscriptionTotalLimitUSDSet bool     // true = explicitly supplied, including null
	DailyLimitUSD                *float64 // 日限额 (USD)
...
type adminServiceImpl struct {
	...
	groupQuotaRepo       GroupSubscriptionQuotaTransitionRepository
