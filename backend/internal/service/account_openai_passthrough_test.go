...
func TestAccount_IsExcelBPSEnabled(t *testing.T) {
	tests := []struct {
		...
		{"agent identity rejected", &Account{Platform: PlatformOpenAI, Type: AccountTypeOAuth, Credentials: map[string]any{"auth_mode": "agent_identity"}, Extra: map[string]any{"openai_excel_bps": true}}, false},
	}
