...
func (s *SettingService) InitializeDefaultSettings(ctx context.Context) error {
	...
	defaults := map[string]string{
		...
		SettingKeyDailyCheckinRewardMin:                     "0.001",
		SettingKeyDailyCheckinRewardMax:                     "0.3",
		SettingKeyDailyCheckinRewardRanges:                  `[{"min":0.001,"max":0.1,"probability":0.5},{"min":0.1,"max":0.2,"probability":0.4},{"min":0.2,"max":0.25,"probability":0.0999},{"min":0.25,"max":0.3,"probability":0.0001}]`,
		SettingKeyDailyCheckinStreakRules:                   `[{"threshold":3,"bonus":0.3},{"threshold":7,"bonus":0.6},{"threshold":14,"bonus":1.2},{"threshold":30,"bonus":2.4}]`,
