...
var (
	...
	ChannelMonitorHistoriesColumns = []*schema.Column{
		...
		{Name: "throughput_tps", Type: field.TypeFloat64, Nullable: true},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "name", Type: field.TypeString, Size: 100},
		{Name: "tag", Type: field.TypeString, Size: 50, Default: ""},
		{Name: "description", Type: field.TypeString, Nullable: true, SchemaType: map[string]string{"postgres": "text"}},
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(11,5)"}},
		...
		{Name: "subscription_quota_reset_mode", Type: field.TypeString, Size: 32, Default: "rolling"},
		...
		{Name: "image_rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(11,5)"}},
		...
		{Name: "video_rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(11,5)"}},
		...
		{Name: "codex_ticket_defaults", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
	...
	SubscriptionPlansColumns = []*schema.Column{
		...
		{Name: "repurchase_cooldown_hours", Type: field.TypeInt, Default: 0},
	...
	UserSubscriptionsColumns = []*schema.Column{
		...
		{Name: "expires_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
		{Name: "term_version", Type: field.TypeInt64, Default: 1},
		{Name: "daily_window_start", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "weekly_window_start", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "monthly_window_start", Type: field.TypeTime, Nullable: true, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "daily_usage_usd", Type: field.TypeFloat64, Default: 0, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
