...
func init() {
	...
	// groupDescTag is the schema descriptor for tag field.
	groupDescTag := groupFields[1].Descriptor()
	// group.DefaultTag holds the default value on creation for the tag field.
	group.DefaultTag = groupDescTag.Default.(string)
	// group.TagValidator is a validator for the "tag" field. It is called by the builders before save.
	group.TagValidator = groupDescTag.Validators[0].(func(string) error)
	...
	// groupDescSubscriptionQuotaResetMode is the schema descriptor for subscription_quota_reset_mode field.
	groupDescSubscriptionQuotaResetMode := groupFields[13].Descriptor()
	// group.DefaultSubscriptionQuotaResetMode holds the default value on creation for the subscription_quota_reset_mode field.
	group.DefaultSubscriptionQuotaResetMode = groupDescSubscriptionQuotaResetMode.Default.(string)
	// group.SubscriptionQuotaResetModeValidator is a validator for the "subscription_quota_reset_mode" field. It is called by the builders before save.
	group.SubscriptionQuotaResetModeValidator = groupDescSubscriptionQuotaResetMode.Validators[0].(func(string) error)
	...
	// groupDescCodexTicketDefaults is the schema descriptor for codex_ticket_defaults field.
	groupDescCodexTicketDefaults := groupFields[58].Descriptor()
	// group.DefaultCodexTicketDefaults holds the default value on creation for the codex_ticket_defaults field.
	group.DefaultCodexTicketDefaults = groupDescCodexTicketDefaults.Default.(domain.GroupCodexTicketDefaults)
	...
	// subscriptionplanDescRepurchaseCooldownHours is the schema descriptor for repurchase_cooldown_hours field.
	subscriptionplanDescRepurchaseCooldownHours := subscriptionplanFields[8].Descriptor()
	// subscriptionplan.DefaultRepurchaseCooldownHours holds the default value on creation for the repurchase_cooldown_hours field.
	subscriptionplan.DefaultRepurchaseCooldownHours = subscriptionplanDescRepurchaseCooldownHours.Default.(int)
	// subscriptionplan.RepurchaseCooldownHoursValidator is a validator for the "repurchase_cooldown_hours" field. It is called by the builders before save.
	subscriptionplan.RepurchaseCooldownHoursValidator = subscriptionplanDescRepurchaseCooldownHours.Validators[0].(func(int) error)
	...
	// usersubscriptionDescTermVersion is the schema descriptor for term_version field.
	usersubscriptionDescTermVersion := usersubscriptionFields[5].Descriptor()
	// usersubscription.DefaultTermVersion holds the default value on creation for the term_version field.
	usersubscription.DefaultTermVersion = usersubscriptionDescTermVersion.Default.(int64)
