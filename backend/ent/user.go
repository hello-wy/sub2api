...
// WelfareRecordsOrErr returns the WelfareRecords value or an error if the edge
// was not loaded in eager-loading.
func (e UserEdges) WelfareRecordsOrErr() ([]*WelfareRecord, error) {
	if e.loadedTypes[13] {
		return e.WelfareRecords, nil
	}
