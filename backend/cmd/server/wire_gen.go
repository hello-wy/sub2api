...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	scheduledTestService := service.ProvideScheduledTestService(scheduledTestPlanRepository, scheduledTestResultRepository, pelicanShowcaseService, groupRepository, apiKeyRepository)
